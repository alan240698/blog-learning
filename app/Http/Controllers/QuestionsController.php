      ...
      if($request->hasFile('question_file')){
          ...
          if($data->count()){
              ...
              if(!empty($arr)){
                  ...
                  return back()->with('added', 'Đọc file câu hỏi thành công!');
              }
              return back()->with('deleted', 'Tập excel rỗng và các trường dữ liệu chưa đúng!');
          }
      }
        return back()->with('deleted', 'Không có dữ liệu nhập!');
    }
...
//THÊM TƯNG CÂU HỎI
    public function store(Request $request)
    {
        ...
        return back()->with('added', 'Thêm câu hỏi thành công!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with('updated', 'Câu hỏi cập nhật thành công!');
    }
    ...
    public function destroy($id)
    {
        ...
        $question->delete();
        return back()->with('deleted', 'Câu hỏi đã được xóa!');
    }
}
