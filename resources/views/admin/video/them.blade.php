                            ...
                            <!-- Truyen du lieu len server su dung _token -->
                                ...
                                <div class="form-group">
                                  <label class="col-sm-2 control-label text-right">Tiêu đề </label>
                                      <div class="col-sm-10">
                                        <input type="text" name="TieuDe" placeholder="Nhập tiêu đề video" class="form-control">
                                      </div>
                                  <label class="col-sm-2 control-label text-right">Link </label>
                                      <div class="col-sm-10">
                                        <input type="text" name="link" placeholder="Nhập địa chỉ link nhúng video" class="form-control">
                                      </div>
