    ...
    <div class="form-element">
        <div class="col-md-12 padding-0">
            ...
            <div class="panel form-element-padding">
                  ...
                  <h4>Bạn đang sửa: <label class="label label-outline label-primary">{{$danhmucbaihoc->Ten}}</label></h4>
                  </div>
                  ...
                  <div class="panel-body" style="padding-bottom:30px;">
                        ...
                        <!-- FORM SỬA -->
                            ...
                            <form action="{{$danhmucbaihoc->id}}" method="POST">
                            <!-- Truyen du lieu len server su dung _token -->
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label text-right">Tên danh mục</label>
                                      <div class="col-sm-10"><input type="text" name="Ten" placeholder="Nhập tên danh mục" value="{{$danhmucbaihoc->Ten}}" class="form-control"></div>
