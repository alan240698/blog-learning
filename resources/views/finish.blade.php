      ...
      <div class="container">
        @if ($setting)
          <a href="{{ url('/') }}" title="{{$setting->welcome_txt}}">
            <img src="{{asset('/images/logo/'. $setting->logo)}}" class="img-responsive" alt="{{$setting->welcome_txt}}" width="150">
          </a>
        @endif
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="navbar-header">
              <!-- Branding Image -->
              @if($setting)
                <a title="Quiz Online" class="tt" href="{{ url('/') }}"><h4 class="heading"><i class="fa fa-flag-checkered" aria-hidden="true"></i> {{$setting->welcome_txt}}</h4></a>
              @endif
            </div>
          </div>
          <div class="col-md-6">
            <div class="collapse navbar-collapse" id="app-navbar-collapse">             
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                @guest
                  ...
                  <li><a href="{{ route('register') }}" title="Register">Đăng ký</a></li>
                @else
                  <li class="dropdown">
      ...
      <div class="col-md-8 col-md-offset-2">
        ...
        @if($topic->show_ans==1)
         ...
         <div class="question-block">
            ...
            <table class="table table-bordered result-table">
              <thead>
                <tr>
                  ...
                  <th style="color: green;">Đáp án đúng</th>
                  <th style="color: red;">Đáp án của bạn</th>
                  <th>Chú thích</th>
                </tr>
              </thead>
              <tbody>
          ...
          <div class="question-block">
            <h2 class="text-center main-block-heading">{{$topic->title}} <br> <small>Kết quả</small></h2>
            <table class="table table-bordered result-table">
              <thead>
                <tr style="background-color: #bd5734; color:#fff;">
                  <th>Số câu hỏi</th>
                  <th>Điểm của bạn</th>
                  <th>Điểm</th>
                  <th>Tổng điểm</th>
            ...
            <h2 class="text-center">Cảm ơn! Chúc may mắn!</h2>
          </div>
        </div>
      </div>
    </div>
